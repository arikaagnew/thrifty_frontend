...
function apiCall (){
    axios.post(`${kBaseUrl}/users/`,{username: state.username, password: state.password})
    .then((response) => {
...
                        </div>
                        <button type="button" className="btn btn-default" onClick={handleClick}><i className="fa fa-arrow-right"></i>Register</button>
                    </form>
